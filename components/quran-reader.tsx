...
export function QuranReader() {
  ...
  return (
    <div className="mushaf-container bg-background text-foreground min-h-screen flex flex-col">
      {/* Header */}
        ...
        <div className="px-4">
          <div className="flex h-12 items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-lg font-semibold tracking-tight text-foreground">Quran Reader</h1>
            </div>
